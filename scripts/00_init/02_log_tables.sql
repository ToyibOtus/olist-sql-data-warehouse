...
(
	...
	batch_end_time DATETIME2(0) NULL,
	batch_load_duration_second INT NULL,
...
(
	...
	load_type NVARCHAR(70) NOT NULL,
	source_object NVARCHAR(250) NOT NULL,
	target_object NVARCHAR(50) NOT NULL,
	step_start_time DATETIME2(0) NOT NULL,
	step_end_time DATETIME2(0) NULL,
	step_load_duration_second INT NULL,
...
(
	...
	batch_id INT NOT NULL,
	step_id INT NULL,
	error_time DATETIME2(0) NOT NULL,
	rows_extracted INT NOT NULL,
	rows_inserted INT NOT NULL,
	rows_updated INT NOT NULL,
	rows_rejected INT NOT NULL,
...
(
	...
	check_time DATETIME2(0) DEFAULT GETDATE() NOT NULL,
